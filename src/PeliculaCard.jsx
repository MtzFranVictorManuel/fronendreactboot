            ...
            {(showSinopsis == true)
                    ...
                    <Card style={{maxWidth: '50rem'}} className="mx-auto">
                        ...
                        <Row className='g-0'>
                            ...
                            <Card.Footer className="small text-uppercase">
                                <Link to={`/Editar/${pelicula.pelicualId}`} className="card-link text-decoration-none">Editar</Link>
                ...
                (
                    <Card style={{maxWidth: '20rem'}} className="mx-auto h-100">
                        ...
                        <Card.Footer className="small text-uppercase">
                            <Link to={`/Detalles/${pelicula.peliculaId}`} className="card-link text-decoration-none">Ver detalles</Link>
                        </Card.Footer>
                    </Card>
                )
            }
